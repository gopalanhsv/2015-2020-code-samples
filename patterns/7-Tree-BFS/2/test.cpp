...
void
printDeqOfVec(const deque<vector<int> >& dOfV) {
    cout << endl;
    for (auto v : dOfV) {
...
testFn(TreeNode* tree) {
    try {
        deque<vector<int> > deqOfVec = Tree::reverseLevelOrderTraverse(tree);
        cout << "Reverse Level Order Traversal Output is: ";
        printDeqOfVec(deqOfVec);
