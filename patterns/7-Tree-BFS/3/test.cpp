...
testFn(TreeNode* tree) {
    try {
        vector<vector<int> > bfsVec = Tree::zigZagTraversal(tree);
        cout << "ZigZag Level Order Traversal Output is: ";
...
constructTestTree2() {
    ...
    tmpNode->setLeftChild(new TreeNode(20));
    tmpNode->setRightChild(new TreeNode(17));
