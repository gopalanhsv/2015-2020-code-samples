...
main() {
    ...
    // Check that student has at least entered some homework grades,
    // in the absence of which display error
    if (!count) {
        cout << "Error! No homework grades have been entered! Exiting...!" << endl;
        return 1;
    }
